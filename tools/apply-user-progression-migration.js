...
/**
 * user_progression 테이블 적용 — ProfileFrame LEVEL canonical
...
const MIGRATION = path.join(__dirname, '..', 'supabase', 'migration_user_progression_canonical.sql');
...
async function main() {
  ...
  console.log(JSON.stringify({ ok: true, applied: 'migration_user_progression_canonical.sql', maskedUrl: maskDatabaseUrl(url) }));
}
